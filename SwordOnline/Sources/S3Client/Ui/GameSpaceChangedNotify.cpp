    ...
    switch (uDataId) {
        ...
        case GDCNI_OBJECT_CHANGED:
            if (uParam) {
                ...
                } else if (pObject->eContainer == UOC_STORE_BOX6) {
                    KUiStoreBox *pStoreBox = KUiStoreBox::GetIfVisible();
                    if (pStoreBox)
                        pStoreBox->UpdateItem(REPOSITORY_SIX, (KUiObjAtRegion *) uParam, nParam);
                } else if (pObject->eContainer == UOC_STORE_BOX7) {
                    KUiStoreBox *pStoreBox = KUiStoreBox::GetIfVisible();
                    if (pStoreBox)
                        pStoreBox->UpdateItem(REPOSITORY_SEVEN, (KUiObjAtRegion *) uParam, nParam);
                } else if (pObject->eContainer == UOC_STORE_BOX8) {
                    KUiStoreBox *pStoreBox = KUiStoreBox::GetIfVisible();
                    if (pStoreBox)
                        pStoreBox->UpdateItem(REPOSITORY_EIGHT, (KUiObjAtRegion *) uParam, nParam);
                } else if (pObject->eContainer == UOC_STORE_BOX9) {
                    KUiStoreBox *pStoreBox = KUiStoreBox::GetIfVisible();
                    if (pStoreBox)
                        pStoreBox->UpdateItem(REPOSITORY_NINE, (KUiObjAtRegion *) uParam, nParam);
                } else if (pObject->eContainer == UOC_STORE_BOX10) {
                    KUiStoreBox *pStoreBox = KUiStoreBox::GetIfVisible();
                    if (pStoreBox)
                        pStoreBox->UpdateItem(REPOSITORY_TEN, (KUiObjAtRegion *) uParam, nParam);
