...
int LuaSelectUI(Lua_State * L)
{
    ...
    else if (Lua_IsString(L, 1+nReduceVal)) 	//�������Ϣ���ַ��������ַ�����ʶ��
    {
...
int LuaAddNote(Lua_State * L)
{
    ...
    UiInfo.m_bParam1 = 0;//nDataType;//����Ϣ�����ͣ��ַ���(0)������(1)
#ifndef _SERVER
    UiInfo.m_bParam2 = 0;
#else
    UiInfo.m_bParam2 = 1;
...
int LuaDelNpc(Lua_State * L)
{
    if (Lua_GetTopIndex(L) <= 0) return 0;
    int nNpcIndex = (int)Lua_ValueToNumber(L, 1);
    // Check if the NPC is a player and return immediately if true
...
int LuaClearMapNpc(Lua_State * L)
{
    ...
    if (nSubWorldIndex >= 0)
    {
        ...
        {
            // Check if the NPC is in the subworld and is not a player
...
int LuaClearMapNpcWithName(Lua_State * L)
{
    ...
    if (nSubWorldIndex >= 0)
    {
        for (int nNpcIndex = 1; nNpcIndex < MAX_NPC; ++nNpcIndex)
        {
            // Check if the NPC is in the subworld, has the specified name, and is not a player
...
TLua_Funcs GameScriptFuns[] =
	...
	{"GetTaskS",		LuaGetTaskString},	//GetTask(�����):��õ�ǰ��Ҹ�����ŵ�ֵ
	{"SetTask",			LuaSetTaskValue},	//SetTask(�����,ֵ):��������ֵ
	{"SyncTaskValue",	LuaSyncTaskValue},	//SetTask(�����,ֵ):��������ֵ
...
///////////////////////////////////////////
	...
	{"DelAllMagic",		LuaDelAllMagic},		//DelMagic(ħ��id��ħ����)
	...
	{"Rev2Pos",			LuaGetPlayerRevivalPos},//SetRevPos(��λ��X����λ��Y)������ҵĵ�ǰ����ĵ����λ��
	...
	{"GetNextExp",		LuaGetNextExp},			//GetExp():�����ҵĵ�ǰ����ֵ
	...
	{"AddStackExp",		LuaAddStackExp},				//AddSumExp(Exp)�������ֱ�ӼӾ���
	...
	{"FindPlayer",		LuaFindPlayer},			//GetUUID()�����ҵ�ΨһID
	...
	{"AddEng",			LuaSetPlayerEngergy},		//AddEng(Value)�����ҵ�����ֵEng
	{"GetDex",			LuaGetPlayerDexterity},		//GetDex()�����ҵ�Dex
	{"AddDex",			LuaSetPlayerDexterity},		//AddDex(Value)�����ҵ�����ֵEng
	{"GetStrg",			LuaGetPlayerStrength},		//GetStrg()
	{"AddStrg",			LuaSetPlayerStrength},		//AddStrg(Value)�����ҵ�����ֵEng
	{"GetVit",			LuaGetPlayerVitality},		//GetVit()
	{"AddVit",			LuaSetPlayerVitality},		//AddVit(Value)�����ҵ�����ֵEng
	{"ResetBaseAttrib",	LuaResetBaseAttribute},		// ���û�������
	...
	{"GetPlayerFortune",LuaGetPlayerFortune},		//GetCash()�����ҵ��ֽ�
	...
	{"GetNpcSkillsExpRate",		LuaGetNpcExpSkillsRate },			//GetExp2Skill():�����ҵĵ�ǰ����ֵ
	//{"SetExpSkill",			LuaSetExpSkill},			//SetExpSkill():�����ҵĵ�ǰ����ֵ
	...
	{"JoinTong",			LuaJoinTong},	//OpenTong()֪ͨ��Ҵ򿪰�����
	...
	{"AddPropPoint",LuaAddPropPoint},//��������Ե�
