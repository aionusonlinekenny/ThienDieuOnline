...
CORE_API void g_InitCore()
{
	time_t ltime;
	time(&ltime);
	printf("===================== Khoi dong Core Game Server =====================\n\n");
	printf("Thoi gian khoi dong.... %s", ctime( &ltime ));

#ifdef _SERVER
	printf("Player toi da cho Server: ..............%d\n", MAX_PLAYER);
	printf("Item toi da cho Server: ................%d\n", MAX_ITEM);
	printf("So luong Npc toi da cho Server: ........%d\n", MAX_NPC);
	printf("Lever toi da: ..........................%d\n", MAX_LEVEL);
...
//	g_SetFilePath("\\");
	...
	} else if (strstr(ModuleName, "gs5.exe")) {
        g_SubWorldSet.Load("\\maps\\WorldSet5.ini");
    } else {
...
int PositionToRoom(int P)
{
	...
	case pos_repositoryroom6:
		return room_repository6;
	case pos_repositoryroom7:
		return room_repository7;
	case pos_repositoryroom8:
		return room_repository8;
	case pos_repositoryroom9:
		return room_repository9;
	case pos_repositoryroom10:
		return room_repository10;
	case pos_traderoom:
		return room_equipment;
	case pos_trade1:
		return room_equipment;
