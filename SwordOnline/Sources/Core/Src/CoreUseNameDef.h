...
#define		MSG_GET_EXP						"B¹n nhËn ®­îc <color=green>%s <color>®iÓm kinh nghiÖm"
#define		MSG_DEC_EXP						"B¹n tæn thÊt <color=green>%s <color>®iÓm kinh nghiÖm"
...
#define		MSG_MOVE_ITEM_HANH_TRANG		"§É chuyÓn vËt phÈm: <color=yellow>%s<color>"
