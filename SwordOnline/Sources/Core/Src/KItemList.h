...
public:
	...
	BOOL 		DoMoveItem(int nItemID, int nSrcRoom, int nSrcX, int nSrcY, int nDestRoom, int destX, int destY, int newPlace, int oldPlace);
...
#ifdef	_SERVER
	BOOL 		AutoMoveToRepository(int nItemID, int nSrcX, int nSrcY, int nSrcPlace, int nDestPlace);
	...
	BOOL 		HandleAutoMoveFromServer(ItemPos sSrc, ItemPos sDest);
	int 		MapPlaceToUIContainer(int place);
