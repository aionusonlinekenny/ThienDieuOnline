...
[1]={"Phóc Duyªn Lé (TiÓu)",6,121,0,0},	--phuc duyen
[2]={"Phóc Duyªn Lé (Trung)",6,122,0,0},	--phuc duyen
[3]={"Phóc Duyªn Lé (§¹i)",6,123,0,0},	--phuc duyen
[4]={"Tèng Kim Chiªu th­ ",6,154,0,0},	--tong kim chieu thu
...
[5]={"L­îng Ng©n kho¸ng",4,118,0,0},	--luong ngan
[6]={"XÝch §ång kho¸ng",4,121,0,0},	--xich dong
[7]={"Tõ ThiÕt kho¸ng",4,138,0,0},	--tu thiet
...
[10]={103,"kh¸ng l«i",4},
[11]={105,"kh¸ng b¨ng",4},
[12]={106,"gi¶m thêi gian lµm chËm",1},
[13]={108,"gi¶m thêi gian tróng ®éc",1},
[14]={110,"gi¶m thêi gian cho¸ng",1},
[15]={99,"®iÓm sinh khÝ",2}
};

--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\jinqian_icon_017ex.spr --ngan luong
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\jingyan_icon_018ex.spr --kinh nghiem
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\kuangshi_icon_020ex.spr --khoang thach
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\wenhao_icon_022ex.spr --ngau nhien
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\quxiao_icon_026ex.spr --co hoi
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\hungjin_icon_019ex.spr --trang bi hk 1
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\teshu_icon_021ex.spr --duoc pham
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\lanse_icon_0191ex.spr --trang bi hk2
--\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\zise_icon_0192ex.spr --trang bi tim 6 dong

GET_REWARDS ={
	{"NgÉu nhiªnLINK:\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\wenhao_icon_022ex.spr","ngaunhien"},
	{"Kho¸ng th¹chLINK:\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\kuangshi_icon_020ex.spr","daquy"},
	{"D­îc phÈmLINK:\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\teshu_icon_021ex.spr","duocpham"}
};

MONEY_RATE=2
EXP_REWARDS={--kinh nghiem th­ëng
	{1000*MONEY_RATE,2000*MONEY_RATE},
	{3000*MONEY_RATE,6000*MONEY_RATE},
	{5000*MONEY_RATE,8000*MONEY_RATE},
	{8000*MONEY_RATE,12000*MONEY_RATE},
	{12000*MONEY_RATE,15000*MONEY_RATE},
	{20000*MONEY_RATE,40000*MONEY_RATE},
	{50000*MONEY_RATE,70000*MONEY_RATE},
	{90000*MONEY_RATE,120000*MONEY_RATE},
	{300000*MONEY_RATE,500000*MONEY_RATE},
	{500000*MONEY_RATE,1000000*MONEY_RATE}
};
...
function shortway()
	...
	Say(10193,3,
	"Dïng 30xu/huyxu",
	-- "30 v¹n l­îng/huytien",
	"§ãng/no"
	)
end

function huyxu()
	if (GetExtPoint() < 30) then
	Msg2Player("C¸c h¹ kh«ng cã ®ñ 30 xu");
    return end
	PayExtPoint(30);
	thuong()
end
...
function SelANum(sel)
	...
	elseif(nSel == 2) then
                           AddExtPoint(2000);
                           Msg2Player("Ng­¬i võa nhËn 2000 Xu")
	elseif(nSel == 3) then
                           AddExtPoint(3000);
                           Msg2Player("Ng­¬i võa nhËn 3000 Xu")
	elseif(nSel == 4) then
                           AddExtPoint(4000);
                           Msg2Player("Ng­¬i võa nhËn 4000 Xu")
	elseif(nSel == 5) then
                           AddExtPoint(5000);
                           Msg2Player("Ng­¬i võa nhËn 5000 Xu")
	elseif(nSel == 6) then
                           AddExtPoint(6000);
                           Msg2Player("Ng­¬i võa nhËn 6000 Xu")
	elseif(nSel == 7) then
                           AddExtPoint(7000);
                           Msg2Player("Ng­¬i võa nhËn 7000 Xu")
	elseif(nSel == 8) then
                           AddExtPoint(8000);
                           Msg2Player("Ng­¬i võa nhËn 8000 Xu")
	elseif(nSel == 9) then
                           AddExtPoint(10000);
                           Msg2Player("Ng­¬i võa nhËn 10.000 Xu")
	return 
	end
		Msg2SubWorld("<pic=135><color=white> Chóc Mõng §¹i HiÖp<color=green> "..GetName().."<color> §· NhËn Th­ëng Thµnh C«ng Khi Hoµn Thµnh<color=orange> "..AWARDS_ARRAY[nSel].."<color> NhiÖm Vô D· TÈu")
	AddCountNews("<pic=135><color=white> Chóc Mõng §¹i HiÖp<color=green> "..GetName().."<color> §· NhËn Th­ëng Thµnh C«ng Khi Hoµn Thµnh<color=orange> "..AWARDS_ARRAY[nSel].." <color> NhiÖm Vô D· TÈu",3)
	logDatau("(\t\t"..GetAccount()..")\t\t("..GetName()..")\t\tIP: "..GetIP().."\t\tLevel: "..GetLevel().."\t\tThuong Nhiem Vu :"..AWARDS_ARRAY[nSel].."  Da Tau")
end;
...
function giao()
	...
	if(count == 0) then
		Talk(1,"KickOutSelf()","Ng­¬i kh«ng ®em g× cho ta c¶ µ? Ta kh«ng hoa m¾t chø?")
	return end
	if(count > 1) then
		Talk(1,"KickOutSelf()","NhiÒu thø qu¸ l·o xem kh«ng ®­îc! Ng­¬i ®Æt vµo tõng mãn th«i!")
	return end
	local nTaskValue = GetTask(TASK_DATAU_ACCEPT);
	local x = GetNumber(1,nTaskValue, 9); --loai item thu' may
	local  nNum = GetNumber(2,nTaskValue,4);--so thu tu
	if(x == 1) then
	Msg2Player(" "..genre.." - "..detail.." - "..parti.." - "..level.." ");
...
function thuong()
	...
	--"Kinh nghiÖmLINK:\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\jingyan_icon_018ex.spr/kinhnghiem",
	--"Ng©n l­îngLINK:\\spr\\ui3\\Ð¢ÈÎÎñÏµÍ³\\½±ÀøÍ¼±ê\\jinqian_icon_017ex.spr/tien",
	--strRand)
...
[11]={6,4815},	--bao tien lo
[12]={4,238},	--bach qua lo
[13]={4,239},	--lam thuy tinh
[14]={4,240},	--tu thuy tinh
[15]={4,240},	--luc thuy tinh
[16]={4,353}	--tinh hong bao thach
};
...
function ClearTask()
	...
	local nDone = GetNumber(3,nTaskDone, 1);--so nv hoan thanh moi ngay
			if nDone == 10 or nDone == 20 or nDone == 30 or nDone == 40  or nDone == 50then
             AddExtPoint(100);
                           Msg2Player("Ng­¬i võa nhËn 1000 Xu")
		-- Msg2SubWorld("<color=wood>§¹i hiÖp<color=white> "..GetName().."<color> may m¾n nhËn ®­îc 5<color=yellow> R­¬ng Vµng<color> khi hoµn thµnh <color=orange>"..nDone.."<color> NV D· TÈu h«m nay")
		end
...
function logDatau(str)
local gm_Log = "dulieu/Datau/ThuongDaTau.txt"
