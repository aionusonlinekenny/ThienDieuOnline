...
function main(NpcIndex)
	...
	local BUY_BLOOD = "Mua tói m¸u luyÖn c«ng[30v¹n-3ngµy]/buy_blood";
...
local nIndex;
	if (GetCash() >= nNeed) then
		nIndex = AddItemID(AddItem(0,2,0,0,0,5,0,0));
		AddTimeItem(nIndex,3*24*60*60); -- 3 ngay su dung
		Msg2Player("Tói sinh lùc luyÖn c«ng ®· ®­îc chuyÓn vµo r­¬ng");
		Pay(nNeed);
	else
	Talk(1,"","Ng­¬i kh«ng cã ®ñ 30 v¹n l­îng, ta kh«ng thÓ gióp ®ì ng­¬i");
	end
