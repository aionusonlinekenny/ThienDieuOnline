...
function kytrandibao()
	Say("Vâ L©m CTC", 10,
              "[ KhuyÕn M·i]§¹i Thµnh BK 90 < 150 v¹n >/daithanh90",
              "§¹i Thµnh BK 120 < 500 v¹n >/bikiep120",
...
return end
Talk(1,"","B¹n kh«ng ®ñ 150 v¹n ®Ó mua");
end
...
AddItemID(AddItem(0,6,74,1,0,5,0,0)); 
 Pay(50000);
Msg2Player("<color=green>B¹n nhËn ®­îc 1 B¹ch CÇu Hoµn.");
return end
