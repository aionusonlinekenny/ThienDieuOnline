...
local checkbang = GetTask(TASK_CUACTC1)

if GetTask(TASK_CUACTC1) < 10 then
 for i=1,2000 do
PlayerIndex = i
w,x,y = GetWorldPos()
if w == 221 then
 SetTask(TASK_CUACTC1,GetTask(TASK_CUACTC1) + 1)
Msg2SubWorld("<color=yellow>Cöa ctc: B×nh Giang M«n ®· bÞ ph¸ vì<color>");
