...
function Revive(NpcIndex)
	...
	local bBlueBoss = 0;
	if (RANDOM(150) < 2) then		--xac suat 2% ra boss xanh
		bBlueBoss = 1;
	end
	if (bBlueBoss == 1) then	--thiet lap thuoc tinh cho boss xanh
		...
		SetNpcExp(NpcIndex, NPCEXP*4);--set kinh nghiem lai nhu cu
		...
		SetNpcResist(NpcIndex, 75, 75, 75, 75, 75, 75);--khang' cac loai
