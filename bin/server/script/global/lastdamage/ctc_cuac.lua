...
local checkbang = GetTask(TASK_CUACTC3)

if GetTask(TASK_CUACTC3) < 10 then
 for i=1,2000 do
PlayerIndex = i
w,x,y = GetWorldPos()
if w == 221 then
 SetTask(TASK_CUACTC3,GetTask(TASK_CUACTC3) + 1)
Msg2SubWorld("<color=yellow>Cöa ctc: §Þnh Xuyªn M«n ®· bÞ ph¸ vì<color>");
