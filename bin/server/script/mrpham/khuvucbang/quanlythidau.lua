...
function main()
Say2("<color=green>Qu¶n Lý Thi §Êu:<color> Vui lßng chän khu vùc thi ®Êu ?",4,1,"",
...
SetFightState(1)
SetCurCamp(4)
SetDeathScript("\\script\\mrpham\\khuvucbang\\tunanthidau.lua")
SetTempRevPos(w,(x+5)*32,(y+5)*32)
SetPKMode(1,1)
SetLogoutRV(1);

if i == 1 then
	Msg2SubWorld("<color=yellow>"..GetName().." <color=red>®· tham gia vµo khu vùc thi ®Êu 1 ")
	xs = random(1,2)
	if xs == 1 then
	...
	Msg2SubWorld("<color=yellow>"..GetName().." <color=red>®· tham gia vµo khu vùc thi ®Êu 2 ")
	xs = random(1,2)
	if xs == 1 then
