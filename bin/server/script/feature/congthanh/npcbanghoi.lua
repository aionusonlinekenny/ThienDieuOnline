function main1()
	Talk(1,"","Sau b¶o tr× 17h00 ngµy 13/09/2021 sÏ cho lËp bang Héi ! ")
end
...
if GetTongNameID() == 0 then
	...
	"Tho¸t./no")
else	Say("<color=green>Qu¶n Lı Bang Héi<color>: Ta chuyªn qu¶n lı nh÷ng vÊn ®Ò vÒ Bang héi ",3,
	--"T×m hiÓu vÒ Bang héi/timhieu",
...
if tongname ~= DanhSachBang[1] and tongname ~= DanhSachBang[2] and tongname ~= DanhSachBang[3] then
