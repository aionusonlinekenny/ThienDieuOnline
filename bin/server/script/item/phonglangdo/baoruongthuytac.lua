...
function levatchung()
	local sel = random(1,50)
		if (sel>47) then 
	        ...
	        Msg2SubWorld("§¹i HiÖp<color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> "..AWARD_RUONG[nstt][2].." <color> tõ B¶o R­¬ng Thñy T¹c!")
        elseif(sel==47) then
	        ...
	        Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc bÝ kÝp 9x tõ B¶o R­¬ng Thñy T¹c!")
        elseif(sel<49 and sel >40 ) then
			AddQuestKey(random(238,240)); -- thuy tinh;
            Msg2Player("B¹n nhËn ®­îc<color=yellow> Thñy Tinh <color>tõ B¶o R­¬ng Thñy T¹c!")
	        Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Thñy Tinh <color> tõ B¶o R­¬ng Thñy T¹c !")
        elseif(sel<40 and sel >20 ) then
	        ...
	        Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Phóc Duyªn <color> tõ B¶o R­¬ng Thñy T¹c !")
		else
			...
			if (nRand==12) then 
				...
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> B¹c Nh­îc T©m Kinh <color> tõ B¶o R­¬ng Thñy T¹c !")
			elseif (nRand==71) then
				AddMagicScript(nRand); -- ttl
				Msg2Player("B¹n nhËn ®­îc<color=yellow> Tiªn Th¶o Lé <color>!")
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Tiªn Th¶o Lé <color> tõ B¶o R­¬ng Thñy T¹c !")
			elseif (nRand==72) then
				AddMagicScript(nRand); -- tsbl
				Msg2Player("B¹n nhËn ®­îc<color=yellow> Thiªn S¬n B¶o Lé <color>!")
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Thiªn S¬n B¶o Lé <color> tõ B¶o R­¬ng Thñy T¹c !")
			elseif (nRand==2629) then
				AddMagicScript(nRand); -- xa loi
				Msg2Player("B¹n nhËn ®­îc<color=yellow> X¸ Lîi Kim §¬n <color>!")
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> X¸ Lîi Kim §¬n <color> tõ B¶o R­¬ng Thñy T¹c !")
			elseif (nRand==353) then
				AddQuestKey(nRand); -- tinh hong bao thach;
				Msg2Player("B¹n nhËn ®­îc<color=yellow> Tinh Hång B¶o Th¹ch <color>!")
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Tinh H«ng B¶o Th¹ch <color> tõ B¶o R­¬ng Thñy T¹c !")
			elseif (nRand==2126) then
				AddMagicScript(nRand); -- long huyet hoan
				Msg2Player("B¹n nhËn ®­îc<color=yellow> Long HuyÕt Hoµn <color>!")
				Msg2SubWorld("§¹i HiÖp <color=yellow> "..GetName().." <color> ®· nhËn ®­îc <color=cyan> Long HuyÕt Hoµn <color> tõ B¶o R­¬ng Thñy T¹c !")
