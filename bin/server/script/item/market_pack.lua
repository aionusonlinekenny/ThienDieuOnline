...
function main(nItemIndex)
	...
	if D == 2344 or D == 2345 or D == 2346 then
		chonnguhanh(nItemIndex,D)
		return 1;
	end

	if D == 2337 then
		nIndex = AddItemID(AddItem(0,0,10,5,2,5,0));
	...
	if D == 2338 then
		nIndex = AddItemID(AddItem(0,0,10,5,4,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end
	...
	if D == 2339 then
		nIndex = AddItemID(AddItem(0,0,10,5,3,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end
	...
	if D == 2340 then
		nIndex = AddItemID(AddItem(0,0,10,5,1,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end	
	...
	if D == 2341 then
		nIndex = AddItemID(AddItem(0,0,10,5,5,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end	
	...
	if D == 2342 then
		nIndex = AddItemID(AddItem(0,0,10,6,1,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end
	...
	if D == 2343 then
		nIndex = AddItemID(AddItem(0,0,10,7,1,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end
	...
	if D == 2405 then
		nIndex = AddItemID(AddItem(0,0,10,8,1,5,0));
		AddTimeItem(nIndex,30*24*60*60) -- 30 ngay;
		RemoveItem(nItemIndex,1);
		return 0;
	end
