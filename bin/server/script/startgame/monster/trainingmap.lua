...
function addtrainingnpc()
	...
	for i=1,getn(CHUTIENTRAN) do
	AddNpcNew(RANDOMC(31,42,43),10,100,CHUTIENTRAN[i][1],CHUTIENTRAN[i][2],DEATHFILE0X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,40,5,10,15,nil,600,nil,nil,DROPFILE0X);
	end

	for i=1,getn(LONGTUYENTHON) do
	AddNpcNew(RANDOMC(31,42,43),10,174,LONGTUYENTHON[i][1],LONGTUYENTHON[i][2],DEATHFILE0X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,40,5,10,15,nil,600,nil,nil,DROPFILE0X);
	end

	for i=1,getn(DAOHUONGTHON) do
	AddNpcNew(RANDOMC(31,42,43),10,101,DAOHUONGTHON[i][1],DAOHUONGTHON[i][2],DEATHFILE0X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,40,5,10,15,nil,600,nil,nil,DROPFILE0X);
	end

	for i=1,getn(VINHLACTRAN) do
	AddNpcNew(RANDOMC(31,42,43),10,99,VINHLACTRAN[i][1],VINHLACTRAN[i][2],DEATHFILE0X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,40,5,10,15,nil,600,nil,nil,DROPFILE0X);
	end

	for i=1,getn(THACHCOTRAN) do
	AddNpcNew(RANDOMC(31,42,43),10,153,THACHCOTRAN[i][1],THACHCOTRAN[i][2],DEATHFILE0X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,40,5,10,15,nil,600,nil,nil,DROPFILE0X);
	end
--------------------------------------------------------------------------------------------------------------------------------------------	
...
--------------------------------------------------------------------------------------------------------------------------------------------
	...
	AddNpcNew(RANDOMC(707,708),100,336,PHONGLANGDO[i][1],PHONGLANGDO[i][2],DEATHFILE10X,
		5,nil,1,RANDOMC(0,1,2,3,4),nil,nil,nil,150,50,55,60,nil,1000,nil,nil,DROPFILE10X);
	end
