--hoangnhk
Include("\\script\\feature\\loidaicbt\\npcpos.lua");
function addnpctuongduong()
	...
	AddNpcNew(1282,1,78,1598*32,3226*32,"\\script\\global\\npcchucnang\\npcchuyenphai.lua",6,"[ NPC] Sø Gi¶ M«n Ph¸i ") --passerby 
	--AddNpcNew(1275,1,78,1565*32,3231*32,"\\script\\global\\npcchucnang\\ghepbanh.lua",6,"[ NPC] Sù KiÖn Ngµy Xu©n ") --passerby 

	-------cong binh tu npc--------------
	AddNpcNew(309,1,NPC_POS[1][1],NPC_POS[1][2]*32,NPC_POS[1][3]*32,"\\script\\feature\\loidaicbt\\congbinhtu.lua",6,868)--passerby094
	AddNpcNew(309,1,NPC_POS[2][1],NPC_POS[2][2]*32,NPC_POS[2][3]*32,"\\script\\feature\\loidaicbt\\congbinhtu.lua",6,868)--passerby094
	AddNpcNew(309,1,NPC_POS[3][1],NPC_POS[3][2]*32,NPC_POS[3][3]*32,"\\script\\feature\\loidaicbt\\congbinhtu.lua",6,868)--passerby094
	AddNpcNew(309,1,NPC_POS[4][1],NPC_POS[4][2]*32,NPC_POS[4][3]*32,"\\script\\feature\\loidaicbt\\congbinhtu.lua",6,868)--passerby094
	---------------NPC hoat dong phu------------------------
	--AddNpcNew(455,1,78,1599*32,3223*32,"\\script\\global\\npcchucnang\\quanlydanhhieu.lua",6,"Qu¶n Lý Danh HiÖu")   -- quan ly danh hieu
	AddNpcNew(455,1,78,1582*32,3227*32,"\\script\\global\\npcchucnang\\nhiemvubanghoi.lua",6,"§Êu Boss Server")   -- thi luyen bang hoi
	AddNpcNew(1576,1,78,1578*32,3230*32,"\\script\\global\\npcchucnang\\vinhdanhtop1.lua",6,"Vinh Danh Top 1")
	----------------
