...
{53139,96290}
	...
	-- AddNpcNew(663,1,53,1619*32,3169*32,"\\script\\global\\npcchucnang\\longngu.lua",6)--enemy199
		AddNpcNew(391,1,53,1615*32,3208*32,"\\script\\global\\npcchucnang\\tientrang.lua",6,70)


	AddNpcNew(373,1,53,1600*32, 3186*32,"\\script\\feature\\congthanh\\npccongthanh.lua",6,"C«ng Thµnh Quan")
	...
	AddNpcNew(359,1,53,1786*32,3184*32,"\\script\\npcthon\\balang\\dukhach.lua",6,237) 
...
AddNpcNew(1528,1,53,1618*32,3177*32,"\\script\\global\\npcchucnang\\trogiup.lua",6,"Hç Trî Test Game ") --308
AddNpcNew(2133,1,53,1623*32,3183*32,"\\script\\global\\npcchucnang\\hotrotanthu.lua",6,"Hç Trî T©n Thñ ") --308
 AddNpcNew(1817,1,53,1632*32,3174*32,"\\script\\global\\npcchucnang\\baovat.lua",6,"Kú Tr©n C¸c [TiÒn V¹n] ")  ---B¶o VËt    ba l¨ng huyÖn
------------------------------------phong ky---------------------------------------------
--AddNpcNew(386,1,53,1587*32,3216*32,"\\script\\cacsukien\\phongky\\dichquan.lua",6,"NhiÖm Vô TÝn Sø ")

AddNpcNew(1596,1,389,1548*32,3098*32,"\\script\\cacsukien\\phongky\\tieuchi1.lua",6,"Tiªu ChÝ 1")

AddNpcNew(1596,1,389,1581*32,2794*32,"\\script\\cacsukien\\phongky\\tieuchi2.lua",6,"Tiªu ChÝ 2")

AddNpcNew(1596,1,389,1582*32,2561*32,"\\script\\cacsukien\\phongky\\tieuchi3.lua",6,"Tiªu ChÝ 3")

AddNpcNew(1596,1,389,1427*32,2570*32,"\\script\\cacsukien\\phongky\\tieuchi4.lua",6,"Tiªu ChÝ 4")

AddNpcNew(1596,1,389,1508*32,2908*32,"\\script\\cacsukien\\phongky\\tieuchi5.lua",6,"Tiªu ChÝ 5")

AddNpcNew(1596,1,389,1495*32,3143*32,"\\script\\cacsukien\\phongky\\tieuchi6.lua",6,"Tiªu ChÝ 6")

AddNpcNew(1596,1,389,1490*32,3007*32,"\\script\\cacsukien\\phongky\\tieuchi7.lua",6,"Tiªu ChÝ 7")

AddNpcNew(1596,1,389,1316*32,3142*32,"\\script\\cacsukien\\phongky\\tieuchi8.lua",6,"Tiªu ChÝ 8")

AddNpcNew(1596,1,389,1395*32,2807*32,"\\script\\cacsukien\\phongky\\tieuchi9.lua",6,"Tiªu ChÝ 9")

AddNpcNew(1596,1,389,1354*32,2569*32,"\\script\\cacsukien\\phongky\\tieuchi10.lua",6,"Tiªu ChÝ 10")

AddNpcNew(1801,1,388,1309*32,2567*32,"\\script\\cacsukien\\duangua\\vedich.lua",6,"VÒ §Ých §ua Ngùa")
--AddNpcNew(1801,1,53,1622*32,3197*32,"\\script\\cacsukien\\duangua\\xuatphat.lua",6,"XuÊt Ph¸t §ua Ngùa")
------------------------------------------------------------------------------------------------------------------------------------------------------------------
AddNpcNew(373,1,11,3148*32, 5066*32,"\\script\\feature\\congthanh\\npccongthanh.lua",6,"C«ng Thµnh Quan")
AddNpcNew(373,1,1,1584*32, 3184*32,"\\script\\feature\\congthanh\\npccongthanh.lua",6,"C«ng Thµnh Quan")
AddNpcNew(373,1,37,1772*32, 3052*32,"\\script\\feature\\congthanh\\npccongthanh.lua",6,"C«ng Thµnh Quan")
AddNpcNew(373,1,78,1584*32, 3210*32,"\\script\\feature\\congthanh\\npccongthanh.lua",6,"C«ng Thµnh Quan")
