...
function addnpcsatthu()
	...
	nNpcIndex = AddNpcNew(815,100,321,41339,83846,DEATHFILEST,
	     5,"B¶o TriÖt S¬n",1,RANDOMC(0,1,2,3,4),0,500000,100,8000,nil,10,20,nil,5*18,50,3,DROPFILEST)	
