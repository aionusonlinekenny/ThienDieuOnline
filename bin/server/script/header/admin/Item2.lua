...
function PL_AddEquip(nSel)
	...
	if nDeltail ~= 1 then
		...
		=
----------===================== --HÖ Kim-- ===================------------------------------
			88 , 100, 0,    ---håi sinh lùc
			121 , 100, 0,    ---T¨ng s¸t th­¬ng VËt lý hÖ Ngo¹i c«ng §iÓm
			126 , 100, 0,    ---T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			114 , 30, 0,    ----kh¸ng tÊt c¶
			168 , 3, 0,        ----T¨ng ®¼ng cÊp kü n¨ng hÖ Kim
			101 , 30, 0,         ----Phßng ®éc t¨ng
			0 , 0, 0,
			0 , 0, 0;
		elseif(nSel == 1) then
			type1 , value1_1, value1_3,
		...
		=
----------===================== --HÖ Méc-- ===================------------------------------
			115 , 80, 0,  ---T¨ng tèc ®é xuÊt chiªu hÖ Ngo¹i c«ng
			125 , 50, 0,  --T¨ng ®éc s¸t hÖ Ngo¹i c«ng
			169 , 3, 0,    --T¨ng ®¼ng cÊp kü n¨ng hÖ méc
			144 , 300, 0,  --T¨ng ®éc s¸t hÖ néi
			126 , 100, 0,   --T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			103 , 30, 0,   ---kh¸ng l«i
			0 , 0, 0,
			0 , 0, 0;
...
----------===================== --HÖ Thñy-- ===================------------------------------
			115 , 80, 0,  ---T¨ng tèc ®é xuÊt chiªu hÖ Ngo¹i c«ng
			123 , 100, 0, ---b¨ng s¸t ngo¹i ®iÓm
			126 , 100, 0,  ---T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			141 , 500, 0, ---b¨ng s¸t néi ®iÓm
			170 , 3, 0,  -----T¨ng ®¼ng cÊp kü n¨ng hÖ thñy
			102 , 30, 0,  ---kh¸ng háa
			0 , 0, 0,
			0 , 0, 0;
		elseif(nSel == 3) then
...
----------===================== --HÖ Háa-- ===================------------------------------
		              115 , 80, 0,  ---T¨ng tèc ®é xuÊt chiªu hÖ Ngo¹i c«ng
			122 , 100, 0,  ---háa s¸t ngo¹i ®iÓm
			171 , 3, 0,  -----T¨ng ®¼ng cÊp kü n¨ng hÖ háa
                                          142 , 500, 0,  ---háa s¸t néi ®iÓm
                                          126 , 100, 0,  ---T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			104 , 30, 0,  ---phßng thñ vËt lý
			0 , 0, 0,
			0 , 0, 0,
			0 , 0, 0;
		else
...
----------===================== --HÖ Thæ-- ===================------------------------------
			115 , 80, 0,  ---T¨ng tèc ®é xuÊt chiªu hÖ Ngo¹i c«ng
			124 , 100, 0,  ---l«i s¸t ngo¹i ®iÓm
			126 , 100, 0,  ---T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			143 , 500, 0,  ---l«i s¸t néi ®iÓm
			172 , 3, 0,  -----T¨ng ®¼ng cÊp kü n¨ng hÖ thæ
			105 , 30, 0,  ---kh¸ng b¨ng
			0 , 0, 0,
			0 , 0, 0;
		end
...
----------===================== --HÖ Kim-- ===================------------------------------
			115 , 80, 0,    ---T¨ng tèc ®é xuÊt chiªu hÖ Ngo¹i c«ng
			121 , 50, 0,    ---T¨ng s¸t th­¬ng VËt lý hÖ Ngo¹i c«ng §iÓm
			126 , 100, 0,    ---T¨ng s¸t th­¬ng vËt lý hÖ Ngo¹i c«ng %
			140 , 1000, 0,    ----T¨ng s¸t th­¬ng vËt lý hÖ néi c«ng ®iÓm hÖ Kim 
			168 , 3, 0,        ----T¨ng ®¼ng cÊp kü n¨ng hÖ Kim
			101 , 30, 0,         ----Phßng ®éc t¨ng
			0 , 0, 0,
			0 , 0, 0;
...
----------------=================-nhÉn hÖ kim-==================-----------------------------
		...
		85 , 500, 0,
		101 , 30, 0,
	              168 , 2, 0,        ----T¨ng ®¼ng cÊp kü n¨ng hÖ Kim
		0 , 0, 0,
		0 , 0, 0,
		0 , 0, 0;
	elseif(nSel == 1) then
