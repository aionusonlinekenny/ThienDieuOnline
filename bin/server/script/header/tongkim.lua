--Author: Kinnox
--Date: 17/09/2020
Include("\\script\\feature\\tongkim\\LIMITED_1_ACCOUNT.lua")
...
tbRANKNAME={"<color=white>Binh s‹<color>", "<color=0,160,240>Hi÷u Ûy<color>", "<color=0,0,240>ThËng l‹nh<color>", "<color=yellow>Ph„ T≠Ìng<color>", "<color=yellow><bclr=red>ßπi T≠Ìng<bclr><color>" , "<color=black>Nguy™n So∏i<color>"}
...
function release_npctk()
	...
	nNpcIndex = AddNpcNew(631,100,380,TONGBINHSI_NPC[i][1],TONGBINHSI_NPC[i][2],BINHSI_FILE,
		nil,nil,1,RANDOMC(0,1,2,3,4),0,36000,nil,500,50,100,200,nil,nil,20,nil,TONGKIM_DROP,1);
		AddMSNpc(1,nNpcIndex,0);
	end
	--hieu uy
	for i=1,getn(TONGHIEUUY_NPC) do
		nNpcIndex = AddNpcNew(632,100,380,TONGHIEUUY_NPC[i][1],TONGHIEUUY_NPC[i][2],HIEUUY_FILE,
		nil,nil,1,RANDOMC(0,1,2,3,4),0,70000,nil,800,100,200,300,nil,4320,30,nil,TONGKIM_DROP);
		AddMSNpc(1,nNpcIndex,0);
	end
	--thong linh
	for i=1,getn(TONGTHONGLINH_NPC) do
		nNpcIndex = AddNpcNew(633,100,380,TONGTHONGLINH_NPC[i][1],TONGTHONGLINH_NPC[i][2],THONGLINH_FILE,
	...
	nNpcIndex = AddNpcNew(637,100,380,KIMBINHSI_NPC[i][1],KIMBINHSI_NPC[i][2],BINHSI_FILE,
		nil,nil,1,RANDOMC(0,1,2,3,4),0,36000,nil,500,50,100,200,nil,nil,20,nil,TONGKIM_DROP,2);
		AddMSNpc(1,nNpcIndex,1);
	end
	--hieu uy
	for i=1,getn(KIMHIEUUY_NPC) do
		nNpcIndex = AddNpcNew(638,100,380,KIMHIEUUY_NPC[i][1],KIMHIEUUY_NPC[i][2],HIEUUY_FILE,
		nil,nil,1,RANDOMC(0,1,2,3,4),0,70000,nil,800,100,200,300,nil,4320,30,nil,TONGKIM_DROP);
		AddMSNpc(1,nNpcIndex,1);
	end
	--thong linh
	for i=1,getn(KIMTHONGLINH_NPC) do
		nNpcIndex = AddNpcNew(639,100,380,KIMTHONGLINH_NPC[i][1],KIMTHONGLINH_NPC[i][2],THONGLINH_FILE,
...
function ExcuteCheck()
	for i = 1,getn(LIMITED_1_ACCOUNT) do -- limited 1 account login TONGKIM
		if GetKeyPc() == LIMITED_1_ACCOUNT[i][1] and GetName() == LIMITED_1_ACCOUNT[i][2] then
			local nNamePlayer;
			local nKey;
				nNamePlayer	= "";
				nKey	= "";
...
function SAVEDULIEU(i,nKey,nNamePlayer)
	if nKey == "" and nNamePlayer == "" then
		...
		SaveData("script/feature/tongkim/LIMITED_1_ACCOUNT.lua",nNAME_Change);
	else
		LIMITED_1_ACCOUNT[getn(LIMITED_1_ACCOUNT)+1] = {nKey,nNamePlayer};
		local nNAME = TaoBang(LIMITED_1_ACCOUNT,"LIMITED_1_ACCOUNT");
		SaveData("script/feature/tongkim/LIMITED_1_ACCOUNT.lua",nNAME);
	end
end
