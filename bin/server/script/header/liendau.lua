...
function showthanhtich(nGroup)
	...
	Say("<color=Gold><npc><color>:\nVâ l©m liªn ®Êu chiÕn ®éi <color=Yellow>"..Name1.."<color>\nThµnh viªn ®éi chiÕn ®Êu: <color=cyan>"..Name1.." "..Name2.."<color>\n§· tham gia "..nTotal.." trËn ®Êu: <color=Green>th¾ng "..nThang.." trËn<color>, <color=Yellow>hßa "..nHoa.." trËn<color>, <color=Red>thÊt b¹i "..nThua.." trËn<color>\nTØ lÖ th¾ng: <color=Yellow>"..nRate.."%<color>\n§iÓm th­ëng: <color=Yellow>"..nPoint.."<color>\nThêi gian tham gia chiÕn ®Êu: <color=Yellow>"..nTime.." gi©y<color>\nXÕp h¹ng thø: <color=Green>"..szNo.."<color>",1,
